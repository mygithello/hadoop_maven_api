 ...
 */
public class HBaseUtilAlone {

    private static Logger LOG = LoggerFactory.getLogger(HBaseUtilAlone.class);
    private static Configuration conf;
    static {
        conf= HBaseConfiguration.create();
      //  conf.set("hbase.zookeeper.quorum","10.176.3.72:2181");
       // conf.set("master","10.176.3.72:60010");
       // System.setProperty("user.home","/root");
     //   System.setProperty("user.name","root");
        conf.set("hbase.zookeeper.quorum","hbase-docker:2181");
        conf.set("master","hbase-docker:60010");
        //conf.set("hbase.zookeeper.quorum", "hbase-docker:16020");// zookeeper地址
        //conf.set("hbase.zookeeper.property.clientPort", "hbase-docker:2181");// zookeeper端口
    }
